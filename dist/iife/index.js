(() => {
  ...
  var import_react55 = __toESM(__require("react"));
  ...
  var import_react_query = __require("react-query");
  ...
  // src/hooks/auth/usePermissions/index.ts
  var import_react_query2 = __require("react-query");
  ...
  var import_react_query3 = __require("react-query");
  var useGetIdentity = ({
    queryOptions
  } = {}) => {
  ...
  var import_react_query4 = __require("react-query");
  var useLogout = () => {
  ...
  var import_react_query5 = __require("react-query");
  ...
  var import_react_query6 = __require("react-query");
  ...
  var import_react_query7 = __require("react-query");
  var useCheckError = () => {
  ...
  var import_react_query8 = __require("react-query");
  ...
  var import_zip = __toESM(__require("lodash/zip"));
  var import_fromPairs = __toESM(__require("lodash/fromPairs"));
  ...
  var import_humanize_string = __toESM(__require("humanize-string"));
  ...
  var import_react_query9 = __require("react-query");

  // src/definitions/table/index.ts
  var import_qs2 = __toESM(__require("qs"));
  var import_unionWith = __toESM(__require("lodash/unionWith"));
  var import_differenceWith = __toESM(__require("lodash/differenceWith"));
  ...
  var import_react_query10 = __require("react-query");
  var useMany = ({
    resource,
    ids,
    queryOptions,
  ...
  var import_react_query11 = __require("react-query");
  ...
  var import_react_query12 = __require("react-query");
  ...
  var import_react_query13 = __require("react-query");
  ...
  var import_react_query14 = __require("react-query");
  var import_pluralize5 = __toESM(__require("pluralize"));
  var useCreateMany = () => {
    const dataProvider = useDataProvider();
    const translate = useTranslate();
    const publish = usePublish();
  ...
  var import_react_query15 = __require("react-query");
  var import_pluralize6 = __toESM(__require("pluralize"));
  var useUpdateMany = () => {
  ...
  var import_react_query16 = __require("react-query");
  var import_pluralize7 = __toESM(__require("pluralize"));
  var useDeleteMany = () => {
    const { mutate: checkError } = useCheckError();
    const {
      mutationMode: mutationModeContext,
  ...
  var import_react_query17 = __require("react-query");
  var useCustom = ({
    url,
    method,
    config,
  ...
  var import_react_query18 = __require("react-query");
  ...
  var import_react_query19 = __require("react-query");
  ...
  var import_react31 = __toESM(__require("react"));
  ...
  var import_react37 = __toESM(__require("react"));
  var useForm = ({
  ...
  var import_chunk = __toESM(__require("lodash/chunk"));
  var useImport = ({
    resourceName,
    mapData = (item) => item,
    paparseOptions,
  ...
  var import_react43 = __require("react");

  // src/contexts/router/index.tsx
  var import_react42 = __toESM(__require("react"));
  var defaultProvider = {
    useHistory: () => false,
    useLocation: () => false,
    useParams: () => ({}),
  ...
  var import_react45 = __require("react");
  var import_react_query20 = __require("react-query");

  // src/contexts/accessControl/index.tsx
  var import_react44 = __toESM(__require("react"));
  ...
  var import_react46 = __require("react");
  ...
  var import_uniqBy = __toESM(__require("lodash/uniqBy"));
  var import_debounce = __toESM(__require("lodash/debounce"));
  var useSelect = (props) => {
  ...
  var import_differenceWith2 = __toESM(__require("lodash/differenceWith"));
  var import_isEqual = __toESM(__require("lodash/isEqual"));
  ...
  var import_react_query21 = __require("react-query");

  // src/contexts/auditLog/index.tsx
  var import_react49 = __toESM(__require("react"));
  ...
  var import_react_query22 = __require("react-query");
  var useLogList = ({
    resource,
    action,
    meta,
  ...
  var import_react_query23 = __require("react-query");
  var useInvalidate = () => {
  ...
  var import_humanize_string2 = __toESM(__require("humanize-string"));
...
For more information, see https://refine.dev/docs/core/hooks/useBreadcrumb/#i18n-support`
  ...
  var import_react54 = __toESM(__require("react"));
  var useMenu = () => {
  ...
  var import_react57 = __toESM(__require("react"));
  var ReadyPage = () => {
  ...
  var import_react60 = __toESM(__require("react"));
  var import_react_query24 = __require("react-query");

  // src/components/telemetry/index.tsx
  var import_react59 = __require("react");
  var import_jose = __require("jose");
  ...
  var Refine = ({
    ...
    return /* @__PURE__ */ import_react60.default.createElement(import_react_query24.QueryClientProvider, {
      ...
      liveMode,
      onLiveEvent
    }, /* @__PURE__ */ import_react60.default.createElement(UnsavedWarnContextProvider, null, /* @__PURE__ */ import_react60.default.createElement(RouterComponent, null, children, !disableTelemetry && /* @__PURE__ */ import_react60.default.createElement(Telemetry, null), /* @__PURE__ */ import_react60.default.createElement(RouteChangeHandler, null)))))))))))))), /* @__PURE__ */ import_react60.default.createElement(import_react_query24.ReactQueryDevtools, {
      initialIsOpen: false,
  ...
  var import_react61 = __require("react");
  ...
  var import_react62 = __toESM(__require("react"));
  var LayoutWrapper = ({
    children,
  ...
  var import_react63 = __toESM(__require("react"));
  var Authenticated = ({
    children,
    fallback,
    loading
  ...
  var import_react64 = __require("react");
  ...
  var import_react65 = __toESM(__require("react"));
  var CanAccess = ({
    resource,
    action,
    params,
